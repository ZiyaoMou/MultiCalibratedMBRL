...
from dmbrl.config.halfcheetah_v4 import HalfCheetahConfigModule

class HalfCheetahMultiDomainConfigModule(HalfCheetahConfigModule):
    ENV_NAME = "MBRLHalfCheetahMultiDomain-v4"
    TASK_HORIZON = 1000
    NTRAIN_ITERS = 300
    ...
    def __init__(self, domain_id=0, noise_scale=0.1):
        self.domain_configs = {
            ...
            2: {"reset_noise_scale": 0.15},
            3: {"reset_noise_scale": 0.2},
            4: {"reset_noise_scale": 0.25},
        }
